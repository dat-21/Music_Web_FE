      ...
      {isOpen && (
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
             ...
             <img src={(currentSong as any).coverUrl || '/default-cover.png'} className="w-full h-full object-cover blur-[80px] opacity-40 scale-110" alt="bg" />
          ...
          <div className="relative z-30 flex-1 flex flex-col items-center justify-center p-6 gap-10">
            ...
            >
               <img src={(currentSong as any).coverUrl || '/default-cover.png'} className="w-full h-full object-cover transition-transform duration-10000 hover:scale-110" alt="cover" />
