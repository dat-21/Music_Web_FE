    ...
    useEffect(() => {
        ...
        const fetchSongDetail = async () => {
            try {
                ...
                // Check structure và set data đúng
            ...
            <div className="relative bg-gradient-to-b from-blue-600 via-blue-800 to-zinc-950 pb-8">
                ...
                <div className="px-6 pt-20 flex items-end gap-6">
                    ...
                    <div className="flex-1 pb-4">
                        ...
                        <h1 className="text-3xl font-bold text-white mb-6 line-clamp-2">
                            {song.title}
                        </h1>
                    ...
                    <div className="bg-gray-800/40 rounded-lg p-6 space-y-4">
                        ...
                        {song.album && (
                            <div className="flex justify-between items-center border-b border-gray-700 pb-3">
                                ...
                                <span className="text-white font-semibold">{song.album}</span>
                            </div>
                        )}
                        ...
                        {typeof song.likes === 'number' && (
                            <div className="flex justify-between items-center border-b border-gray-700 pb-3">
                                ...
                                <span className="text-white font-semibold">{song.likes.toLocaleString()}</span>
                            </div>
                        )}
                        ...
                        {typeof song.plays === 'number' && (
                            <div className="flex justify-between items-center border-b border-gray-700 pb-3">
                                ...
                                <span className="text-white font-semibold">{song.plays.toLocaleString()}</span>
                            </div>
                        )}
